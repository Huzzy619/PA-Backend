...
SECRET_KEY = "django-insecure-3o3n569em9!b%zf$r9w=lvd-%#r(cs*fi+b+9-(^6ysudv)^@!"
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Personal_Assistant API",
    "DESCRIPTION": "The API documentation for Personal_Assistant API",
    "VERSION": "0.1.0",
